...
import { Edit, Eye, FileText, Globe, Plus, Save, Trash2 } from "lucide-react";
...
export default function ContentPage() {
  ...
  const [_selectedContent, setSelectedContent] = useState<ContentItem | null>(
    null,
  );
  ...
  const [contentItems] = useState<ContentItem[]>([
    {
      ...
      type: "page",
      content:
        "Learn about Helen's Beauty Secret and our commitment to organic skincare...",
    ...
    },
    {
      ...
      type: "blog",
      content:
        "Organic skincare products offer numerous benefits for your skin...",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage pages, blog posts, and FAQ content
          </p>
        </div>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Update your content</DialogDescription>
          </DialogHeader>
