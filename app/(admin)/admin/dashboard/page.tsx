                  ...
                  {topProducts.slice(0, 5).map((product, index) => (
                    <div key={product.productId} className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm font-medium">{product.product?.name || 'Unknown Product'}</p>
              ...
              {selectedOrder.deliveryMethod && (
                <Card>
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">{selectedOrder.deliveryMethod.name}</p>
                        <p className="text-sm text-muted-foreground">
                          {selectedOrder.deliveryMethod.estimatedDays}
                        </p>
                      </div>
                      <p className="font-medium">${selectedOrder.deliveryMethod.price.toFixed(2)}</p>
                    </div>
                  </CardContent>
                </Card>
              )}
                    ...
                    {selectedOrder.items?.map((item: any, index: number) => (
                      <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <p className="font-medium">{item.product?.name || `Product #${item.productId?.slice(-8) || 'Unknown'}`}</p>
                            <p className="text-sm text-muted-foreground">
