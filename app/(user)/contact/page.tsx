            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our dedicated support team is available to help you with
                      any questions or concerns about our products and services.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="space-y-3">
                  <a
                    href="/faq#shipping"
                    className="flex items-center space-x-3 text-muted-foreground hover:text-green-600 transition-colors"
                  >
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8">
            Check out our comprehensive FAQ section or reach out to our support
            team
          </p>
