...
const ingredients = [
  {
    ...
    type: "Hydrating",
    description:
      "A powerful humectant that can hold up to 1000 times its weight in water, providing intense hydration and plumping effects.",
    benefits: [
      "Deep hydration",
      "Plumps skin",
      "Reduces fine lines",
  ...
  },
  {
    ...
    type: "Antioxidant",
    description:
      "A potent antioxidant that brightens skin, reduces hyperpigmentation, and stimulates collagen production.",
    benefits: [
  ...
  },
  {
    ...
    type: "Skin Barrier",
    description:
      "A form of vitamin B3 that strengthens the skin barrier, reduces inflammation, and minimizes pore appearance.",
    benefits: [
  ...
  },
  {
    ...
    type: "Anti-Aging",
    description:
      "A derivative of vitamin A that accelerates cell turnover, reduces fine lines, and improves skin texture.",
    benefits: [
      "Reduces fine lines",
      "Improves texture",
  ...
  },
  {
    ...
    type: "Moisturizing",
    description:
      "Lipids that naturally occur in the skin barrier, helping to retain moisture and protect against environmental damage.",
    benefits: [
      "Locks in moisture",
  ...
  },
  {
    ...
    type: "Anti-Aging",
    description:
      "Amino acid chains that signal skin cells to produce more collagen, resulting in firmer, more youthful-looking skin.",
    benefits: [
      "Stimulates collagen",
      "Firms skin",
      "Reduces wrinkles",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Discover the powerful, natural ingredients that make our products
              so effective. Each ingredient is carefully selected for its proven
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {selectedIngredient.sustainability}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {selectedIngredient.rating} ({selectedIngredient.reviews}{" "}
                      reviews)
                    </span>
                  </div>
