      ...
      questions: [
        {
          ...
          answer: "Yes, all our products are certified organic and made with 100% natural ingredients. We're committed to clean, sustainable beauty and work with certified organic suppliers."
        },
        {
          question: "What skin types are your products suitable for?",
          answer: "Our products are formulated for all skin types including sensitive, oily, dry, and combination skin. Each product clearly indicates the recommended skin types on the packaging."
        },
        {
          question: "Do you test on animals?",
          answer: "Never! We are 100% cruelty-free and never test our products on animals. We only test on humans who volunteer to try our products."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "Yes, we ship worldwide with local pricing adjustments to ensure fair access to our premium skincare products. Shipping times vary by location."
        },
        {
          question: "How long does shipping take?",
          answer: "Domestic orders typically arrive within 3-5 business days. International orders take 7-14 business days depending on your location."
        },
        {
          question: "Is there free shipping?",
          answer: "Yes! We offer free worldwide shipping on orders over $50. For orders under $50, shipping is $9.99."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "We offer a 30-day satisfaction guarantee. If you're not completely satisfied, we'll provide a full refund. Returns must be in original packaging."
        },
        {
          question: "How do I return a product?",
          answer: "Simply contact our customer service team with your order number, and we'll provide you with a prepaid return label and instructions."
        },
        {
          question: "Can I exchange a product for a different one?",
          answer: "Yes! We offer exchanges within 30 days of purchase. Contact our customer service team to arrange an exchange."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: "You can reach us via email at support@helensbeautysecret.com, through our contact form, or by phone at 1-800-BEAUTY. We typically respond within 24 hours."
        },
        {
          question: "Do you offer samples?",
          answer: "Yes! We offer sample sizes of our most popular products. You can request samples when you place an order or contact us directly."
        },
        {
          question: "Are your products safe for pregnant women?",
          answer: "Most of our products are safe for pregnant women, but we recommend consulting with your healthcare provider before using any new skincare products during pregnancy."
        }
      ]
    }
  ];
              ...
              <div className="space-y-10">
                <div className="space-y-8">
                  ...
                  <div className="inline-block">
                    <Badge variant="secondary" className="w-fit bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border-green-200 shadow-lg hover:shadow-xl transition-all duration-300 group">
                  ...
                  <div className="space-y-4">
                    <h1 className="text-4xl lg:text-6xl font-bold text-foreground leading-tight">
                      <span className="block opacity-0 animate-fade-in-up">Transform Your</span>
                  ...
                  <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-2xl opacity-0 animate-fade-in-up delay-600">
                    Discover the power of premium organic skincare. Clean, effective, and sustainable beauty products that deliver real results for radiant, healthy skin.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-6 opacity-0 animate-fade-in-up delay-800">
                  <Link href="/shop">
                    <Button size="lg" className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-10 py-5 text-lg font-semibold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 group transform hover:scale-105">
                      <Zap className="mr-2 h-5 w-5 group-hover:rotate-12 transition-transform duration-300" />
                      Shop Collection
                      <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
                    </Button>
                  </Link>
                  <Button size="lg" variant="outline" className="border-2 border-green-600 text-green-600 hover:bg-green-50 dark:hover:bg-green-950/20 px-10 py-5 text-lg font-semibold rounded-2xl transition-all duration-300 group transform hover:scale-105 backdrop-blur-sm">
                ...
                <div className="relative z-10">
                  ...
                  <div className="relative w-full h-96 lg:h-[600px] group">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center p-8">
                        <div className="w-72 h-80 bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-green-900 rounded-2xl shadow-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                          <div className="text-center">
                            ...
                            <p className="text-lg font-semibold text-foreground">Premium Serum</p>
                            <p className="text-sm text-muted-foreground mt-2">Organic & Natural</p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="absolute -top-6 -left-6 w-28 h-36 bg-white/90 dark:bg-gray-800/90 rounded-2xl shadow-xl p-4 transform rotate-12 hover:rotate-0 transition-all duration-500 group-hover:scale-110 backdrop-blur-sm border border-white/20">
                      ...
                      <p className="text-xs font-medium text-foreground text-center">Award Winner</p>
                    </div>
                    ...
                    <div className="absolute -bottom-6 -right-6 w-28 h-36 bg-white/90 dark:bg-gray-800/90 rounded-2xl shadow-xl p-4 transform -rotate-12 hover:rotate-0 transition-all duration-500 group-hover:scale-110 backdrop-blur-sm border border-white/20">
                      ...
                      <p className="text-xs font-medium text-foreground text-center">Global Shipping</p>
                    </div>
                ...
                <div key={category.category} className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {category.questions.map((faq, faqIndex) => {
                      ...
                      return (
                        <Card key={faqIndex} className="overflow-hidden hover:shadow-lg transition-all duration-300">
                          <button
              ...
              <Card className="max-w-2xl mx-auto bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/50 dark:to-emerald-950/50 border-green-200 dark:border-green-800">
                <CardContent className="p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link href="/faq">
                      <Button variant="outline" className="border-green-600 text-green-600 hover:bg-green-50 dark:hover:bg-green-950/20 px-8 py-3 rounded-xl">
                        View All FAQs
                      </Button>
                    </Link>
                  </div>
