    ...
    switch (event.type) {
      case 'payment_intent.succeeded':
        ...
        try {
          ...
          console.error('Failed to update order for payment intent:', paymentIntent.id, error);
        }
      ...
      case 'payment_intent.payment_failed':
        ...
        try {
          ...
          console.error('Failed to update order for failed payment:', failedPayment.id, error);
        }
      ...
      case 'checkout.session.expired':
        ...
        try {
          ...
          if (order) {
            ...
            console.log('Order cancelled for expired session:', expiredSession.id);
          }
        } catch (error) {
          console.error('Failed to process expired checkout session:', expiredSession.id, error);
        }
