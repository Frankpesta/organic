  ...
  handler: async (ctx) => {
    ...
    const products = [
      {
        ...
        description:
          "A powerful vitamin C serum that brightens skin and reduces dark spots while providing deep hydration. Formulated with 20% vitamin C and hyaluronic acid for maximum effectiveness.",
        ...
        howToUse:
          "Apply 2-3 drops to clean skin morning and evening. Gently pat into skin until absorbed.",
        seoTitle: "Hydrating Vitamin C Serum - Helen's Beauty Secret",
        seoDescription:
          "Brighten your skin with our hydrating vitamin C serum. 20% vitamin C with hyaluronic acid for maximum effectiveness.",
        metaKeywords: [
          "vitamin c serum",
          "brightening serum",
          "anti-aging",
      ...
      },
      {
        ...
        description:
          "A gentle yet effective foaming cleanser that removes dirt, oil, and makeup without stripping your skin. Perfect for all skin types, especially sensitive skin.",
        ...
        howToUse:
          "Wet face with lukewarm water. Apply cleanser and gently massage in circular motions. Rinse thoroughly.",
        seoTitle: "Gentle Foaming Cleanser - Helen's Beauty Secret",
        seoDescription:
          "Gentle foaming cleanser that removes dirt and makeup without stripping skin. Perfect for sensitive skin.",
        metaKeywords: [
          "gentle cleanser",
          "foaming cleanser",
          "sensitive skin",
      ...
      },
      {
        ...
        description:
          "Rich night cream formulated with retinol and peptides to reduce fine lines and wrinkles while you sleep. Wake up to smoother, more youthful-looking skin.",
        ...
        howToUse:
          "Apply to clean skin before bedtime. Gently massage in upward motions until absorbed.",
        seoTitle: "Anti-Aging Night Cream - Helen's Beauty Secret",
        seoDescription:
          "Rich night cream with retinol and peptides to reduce fine lines and wrinkles while you sleep.",
        metaKeywords: [
          "anti-aging cream",
          "night cream",
          "retinol cream",
      ...
      },
      {
        ...
        description:
          "Ultra-hydrating body lotion that nourishes and softens skin from head to toe. Lightweight formula absorbs quickly without leaving a greasy residue.",
        ...
        howToUse:
          "Apply to clean, dry skin after showering. Massage gently until absorbed.",
        seoTitle: "Hydrating Body Lotion - Helen's Beauty Secret",
        seoDescription:
          "Ultra-hydrating body lotion that nourishes and softens skin without greasy residue.",
        metaKeywords: [
          "body lotion",
          "hydrating lotion",
          "moisturizer",
      ...
      },
      {
        ...
        description:
          "Everything you need for a complete skincare routine. Includes cleanser, serum, moisturizer, and eye cream. Perfect for beginners or as a gift.",
        ...
        seoDescription:
          "Complete 4-piece skincare routine set with everything you need for healthy, glowing skin.",
        metaKeywords: [
          "skincare set",
          "gift set",
          "complete routine",
    ...
    const settings = [
      ...
      },
      {
        ...
        value:
          "Pure, organic skincare that transforms your complexion naturally.",
        updatedAt: Date.now(),
      },
      {
        key: "currency",
