...
const sampleProducts = [
  ...
  },
  {
    ...
    description:
      "Remove makeup and impurities with our luxurious cleansing oil. This gentle formula melts away even waterproof makeup while nourishing your skin. Enriched with organic oils and botanical extracts for a spa-like cleansing experience.",
    shortDescription:
      "Luxurious oil cleanser that melts makeup and nourishes skin",
    price: 32.0,
    comparePrice: 42.0,
    sku: "GCO-003",
    images: [
    ...
    howToUse:
      "Apply to dry skin and massage gently. Add water to emulsify, then rinse thoroughly with warm water.",
    seoTitle: "Gentle Cleansing Oil - Makeup Remover & Skin Nourisher",
    seoDescription:
      "Remove makeup gently with our nourishing cleansing oil. Enriched with organic oils for a spa-like experience.",
    metaKeywords: [
      "cleansing oil",
      "makeup remover",
      "oil cleanser",
  ...
  },
  {
    ...
    description:
      "Reveal brighter, smoother skin with our gentle exfoliating scrub. Made with natural jojoba beads and fruit enzymes, this scrub removes dead skin cells without irritation. Perfect for weekly use to maintain a healthy glow.",
    shortDescription:
      "Gentle exfoliating scrub with jojoba beads for brighter skin",
    price: 25.0,
    comparePrice: 32.0,
    sku: "EFS-005",
    images: [
    ...
    howToUse:
      "Apply to wet skin and gently massage in circular motions for 30 seconds. Rinse thoroughly with warm water. Use 1-2 times per week.",
    seoTitle: "Exfoliating Face Scrub - Gentle Jojoba Bead Exfoliator",
    seoDescription:
      "Reveal brighter skin with our gentle exfoliating scrub. Natural jojoba beads remove dead skin cells safely.",
    metaKeywords: [
      "face scrub",
      "exfoliator",
      "jojoba beads",
  ...
  },
  {
    ...
    description:
      "Wake up to younger-looking skin with our intensive night cream. This rich, luxurious formula works while you sleep to reduce fine lines, improve skin firmness, and restore your skin's natural radiance. Enriched with retinol and peptides.",
    shortDescription:
      "Intensive night cream with retinol and peptides for younger-looking skin",
    price: 65.0,
    comparePrice: 85.0,
    sku: "ANC-006",
    images: [
    ...
    howToUse:
      "Apply to clean skin before bed. Start with every other night if you're new to retinol. Always use SPF during the day.",
    seoTitle: "Anti-Aging Night Cream - Retinol & Peptide Treatment",
    seoDescription:
      "Wake up to younger skin with our intensive night cream. Retinol and peptides reduce fine lines while you sleep.",
    metaKeywords: [
      "night cream",
      "anti-aging",
      "retinol",
...
async function seedDatabase() {
  try {
    ...
    for (const category of sampleCategories) {
      const _result = await client.mutation(
    ...
    for (const product of sampleProducts) {
      const _result = await client.mutation("products:createProduct", product);
